...
///
/// These are the segments `env_types = ::my::env_types::Environment` and `compile_as_dependency = true`
/// in `#[ink::contract(env_types = ::my::env_types::Environment, compile_as_dependency = true`.
